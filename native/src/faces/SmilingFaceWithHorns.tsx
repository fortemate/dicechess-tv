// Generated from src/assets/faces/rhosgfx/smiling-face-with-horns.svg.
  ...
  <Svg width={size} height={size} viewBox="0 0 64 64">
    <G>
      <G>
        ...
        <Path
          fill="#d769ff"
          d="M59.49,32h0c.15-10.25-1.21-20.67-11.85-24.65C42.69,5.49,37.26,5.46,32,5.51h0C21.75,5.36,10.33,6.72,6.35,17.36,4.49,22.31,4.46,26.74,4.51,32h0C4.36,42.25,5.72,53.67,16.36,57.65c4.95,1.86,10.38,1.89,15.64,1.84h0c10.25.15,21.67-1.21,25.65-11.85C59.51,42.69,59.54,37.26,59.49,32Z"
        />
        <Path
          fill="#a0f"
        ...
        />
        <Ellipse fill="#a0f" cx={51} cy={39.49} rx={5.56} ry={3.55} />
        <Ellipse fill="#a0f" cx={13} cy={39.49} rx={5.56} ry={3.55} />
        <Circle fill="#fff" cx={44.5} cy={31.37} r={7.78} />
        <Circle fill="#fff" cx={19.5} cy={31.37} r={7.78} />
        <Circle fill="#1a1a1a" cx={42.34} cy={31.37} r={4.52} />
        <Circle fill="#1a1a1a" cx={21.66} cy={31.37} r={4.52} />
        <Path
          fill="#7900bf"
        ...
        <Path
          fill="#1a1a1a"
          d="M23.71,43.12a27.17,27.17,0,0,0,4.15,1.25,19.91,19.91,0,0,0,4.14.41,20.7,20.7,0,0,0,4.13-.44,32.28,32.28,0,0,0,4.16-1.22h0A1.14,1.14,0,0,1,41.54,45a11.72,11.72,0,0,1-4.35,2.85,13.92,13.92,0,0,1-5.19,1A13.46,13.46,0,0,1,22.46,45a1.14,1.14,0,0,1,0-1.61,1.12,1.12,0,0,1,1.19-.25Z"
        />
      </G>
    </G>
  </Svg>
